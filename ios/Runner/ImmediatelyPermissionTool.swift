...
// __CLOSE_PRINT__
//
//  ImmediatelyPermissionTool.swift
//  OverseaH5
//
...
class ImmediatelyPermissionTool {
    //: static let shared = AppPermissionTool()
    static let shared = ImmediatelyPermissionTool()
    ...
    func technique(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        //: if #available(iOS 14, *) {
        if #available(iOS 14, *) {
    ...
    func pathSum(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
